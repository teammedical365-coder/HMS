            ...
            <div className="auth-container">
                <div className="auth-card">
                    ...
                    <div className="auth-header">
                        <h1>🏛️ Central Admin Login</h1>
                        <p>Sign in to the Central Administration Portal</p>
                    </div>
                    ...
                    <div className="auth-footer">
                        <p>
                            ...
                            <Link to="/supremeadmin/signup" className="auth-link">Sign Up</Link>
                        </p>
                        <p style={{ marginTop: '12px', fontSize: '0.85rem', color: 'var(--text-gray)' }}>
                            Hospital Admin?{' '}
                            <Link to="/hospitaladmin/login" className="auth-link" style={{ fontSize: '0.85rem' }}>
