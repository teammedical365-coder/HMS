            ...
            <div className={`centraladmin-container ${selectedHospital ? 'has-sidebar-padding' : ''}`}>
                    ...
                    <div>
                        <div className="admin-card">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                                <div>
                                    <h2>{activeTab === 'hospitals' ? '≡ƒÅÑ Enterprise Plan' : '≡ƒÅÑ Multi-Speciality Starter Plan'}</h2>
                            ...
                            {activeTab === 'multi-speciality' && (
                                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', marginBottom: '24px', display: 'flex', flexWrap: 'wrap', gap: '24px' }}>
                                    <div style={{ flex: '1 1 300px' }}>
                                        <h3 style={{ color: '#0f172a', margin: '0 0 8px 0' }}>Multi-Speciality Starter Plan <span style={{ color: '#10b981', fontSize: '1.2rem', marginLeft: '8px' }}>Γé╣30,000 / Year</span></h3>
                                        ...
                                        <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: '#475569', fontSize: '14px', lineHeight: '1.8' }}>
                                            ...
                                            <li>Γ£ö Up to 14 Staff Accounts</li>
                                    ...
                                    <div style={{ flex: '1 1 300px', background: '#fff', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '16px' }}>
                                        ...
                                        <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: '#475569', fontSize: '14px', lineHeight: '1.8' }}>
                                            ...
                                            <li>Γ£ö Lead Generation Forms</li>
                                        </ul>
                                    </div>
                                </div>
                            )}
                ...
                {(activeTab === 'simple-clinics' || activeTab === 'clinic-basic') && !selectedClinic && (
                    <div>
                        <div className="admin-card">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                                <div>
                                    <h2>{activeTab === 'simple-clinics' ? '≡ƒÅ¬ Starter Plan' : '≡ƒ⌐║ Clinic Basic Plan'}</h2>
                                    <p style={{ color: '#888', fontSize: '13px', margin: '4px 0 0' }}>
                            ...
                            {showClinicForm && (
                                <div className="ca-form-box" style={{ marginBottom: '24px' }}>
                                    <h3>{editClinic ? 'Γ£Å∩╕Å Edit Clinic' : (activeTab === 'simple-clinics' ? '≡ƒÅ¬ Add Starter Clinic' : '≡ƒ⌐║ Add Basic Clinic')}</h3>
                                    {error && <div className="error-message">{error}</div>}
                                    {success && <div className="success-message">{success}</div>}
                ...
                {activeTab === 'simple-clinics' && selectedClinic && (
                    <div>
                        ...
                        {error && <div className="error-message" style={{ marginBottom: '16px' }}>ΓÜá∩╕Å {error}</div>}
                        {success && <div className="success-message" style={{ marginBottom: '16px' }}>Γ£à {success}</div>}
