...
function getTenantModels(tenantDb) {
    ...
    const { nursingNoteSchema } = require('../models/nursingNote.model');
    const { nursingTaskSchema } = require('../models/nursingTask.model');
    const { ipdIntakeOutputSchema } = require('../models/ipdIntakeOutput.model');
    const { ipdLineSchema } = require('../models/ipdLine.model');
    ...
    return {
        ...
        NursingNote: model('NursingNote', nursingNoteSchema),
        NursingTask: model('NursingTask', nursingTaskSchema),
        IPDIntakeOutput: model('IPDIntakeOutput', ipdIntakeOutputSchema),
        IPDLine: model('IPDLine', ipdLineSchema),
